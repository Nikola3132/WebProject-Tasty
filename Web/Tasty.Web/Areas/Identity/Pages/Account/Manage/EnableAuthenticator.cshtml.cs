namespace Tasty.Web.Areas.Identity.Pages.Account.Manage
{
...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        public EnableAuthenticatorModel(
            UserManager<TastyUser> userManager,
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(TastyUser user)
        {
